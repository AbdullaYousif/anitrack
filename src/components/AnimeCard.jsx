  ...
  return (
    <div className="bg-gray-900 text-white flex flex-col rounded-xl overflow-hidden ">
      ...
      <div className="p-3 flex flex-col flex-1">
        ...
        {inWatchlist && <select className="bg-gray-800 text-white text-sm rounded mt-2 w-full p-1 outline-none border border-gray-700" value={status} onChange={(e => onChangeStatus(e.target.value))} name="watchlistStatus" id="">
